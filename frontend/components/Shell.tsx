...
import { Activity, Flame, LayoutDashboard, LineChart, ListOrdered, ScanSearch, Settings2, Zap } from "lucide-react";
import { KillSwitch } from "./KillSwitch";
import { DeskProvider, useDesk } from "./useDesk";

const NAV = [
  { href: "/", label: "Overview", icon: LayoutDashboard },
  { href: "/slow", label: "Slow", icon: LineChart },
  { href: "/snap", label: "Snap", icon: Flame },
  ...
  return (
    <div className="min-h-screen grid grid-cols-[240px_1fr]">
      <aside className="border-r border-white/5 bg-ink-900/80 backdrop-blur-md px-5 py-6 flex flex-col">
        <div className="mb-8">
          <div className="text-[11px] tracking-[0.28em] text-zinc-500">MARKETS</div>
      ...
      <div className="min-w-0">
        <header className="sticky top-0 z-20 flex items-center justify-between border-b border-white/5 bg-[#07080b]/75 backdrop-blur-xl px-8 py-4">
          <div>
            ...
            <div className="text-sm text-zinc-300">Slow ETFs · Snap QQQ · Pulse crypto</div>
          </div>
